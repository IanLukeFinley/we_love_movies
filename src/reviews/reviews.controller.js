...
async function checkParameters(req, res, next) {
...
module.exports = {
  ...
  read: [asyncErrorBoundary(checkParameters), read],
  put: [asyncErrorBoundary(checkParameters), hasBody, asyncErrorBoundary(put)],
  delete: [asyncErrorBoundary(checkParameters), asyncErrorBoundary(destroy)],
};